...
check_interactive_mode() {
    ...
    if [ ! -t 0 ]; then
        ...
        echo "curl -fsSL https://raw.githubusercontent.com/scan-dev/AIControl/vmlab/install.sh -o install.sh"
        echo ""
        ...
        echo "curl -fsSL https://raw.githubusercontent.com/scan-dev/AIControl/vmlab/install.sh | bash -s essential"
        echo ""
    ...
    while [ $# -gt 0 ]; do
        case "$1" in
            ...
            --help|-h|help)
                ...
                echo "  curl -fsSL https://raw.githubusercontent.com/scan-dev/AIControl/vmlab/install.sh | bash -s developer"
                echo ""
